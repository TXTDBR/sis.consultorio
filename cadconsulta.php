	...
	<body>
		...
		<div class="container">	
			<form action="inserirconsulta.php" method="POST">
				<div class="row">
					<div class="col-md-12">
						<span><h3 class="text-center text-dark"></br><b>Cadastrar Consulta</b></h3><hr></span>
						<div class="form-group">
							<label><span>Paciente</span></label>
							<input type="text" class="form-control" name="paciente" placeholder="Digite o nome do paciente" required=""> <small id="ajuda" class="form-text text-muted">Informe o nome completo do paciente.</small>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<small id="ajuda" class="form-text text-muted">Informe a especialidade da consultar.</small>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
